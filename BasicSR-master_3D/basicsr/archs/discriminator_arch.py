"""
Code adapted by Sonia Laguna, modified discrimator size to adapt to dataset
"""
...
@ARCH_REGISTRY.register()
class VGGStyleDiscriminator128_2(nn.Module):
    """VGG style discriminator with input size 128 x 128.
    ...
    def __init__(self, num_in_ch, num_feat):
        super(VGGStyleDiscriminator128_2, self).__init__()
        ...
        self.conv4_1 = nn.Conv2d(num_feat * 8, num_feat * 8, 3, 2, 1, bias=False)
        self.bn4_1 = nn.BatchNorm2d(num_feat * 8, affine=True)

        self.linear1 = nn.Linear(num_feat * 4 * 4, 100)
        self.linear2 = nn.Linear(100, 1)
